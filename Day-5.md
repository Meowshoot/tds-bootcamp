...
--- Before Day-5 ---
I already knew how to make basic commits in Git and push to GitHub.
--- 
...
- How Git keeps track of tags and tag pushes.
- The Git internal storage model (working directory, staging index, repository commit history).
---

--- Feedback (Suggestions for the TDS Team) ---
Excellent explanation of the Git conceptual model. Pushing tags and configuring branch defaults are very useful.
---
