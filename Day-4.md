...
--- Before Day-4 ---
I already knew basic HTTP methods (GET/POST) and how to view network requests in Chrome.
--- 
...
- How to structure FastAPI endpoints with query parameters and request bodies.
- Navigating and testing REST APIs using `/docs` automatic Swagger documentation.
---

--- Feedback (Suggestions for the TDS Team) ---
Excellent explanations of network protocols and HTTP status codes, particularly the hands-on API development task.
---
