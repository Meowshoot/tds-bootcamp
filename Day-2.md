...
--- Before Day-2 ---
I already knew how to navigate the command line and view files using basic commands.
--- 
...
- How environment variables are scoped.
- Handling of command output redirection and error handling (`2>`).
---

--- Feedback (Suggestions for the TDS Team) ---
Great instructions and very helpful explanations of core terminal concepts.
---
